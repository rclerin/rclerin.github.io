export function SortIndividuel(data) {
    return (
        <div className="gridContainer">
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/2" }}>Niveau</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "2/4" }}>Sort</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Activation</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/4" }}>Durée</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "4/6" }}>Type de magie</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Sort incanté 1 niveau supérieur</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/6" }}>Sort incanté 2 niveau supérieur</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Sort incanté 3 niveau supérieur</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/6" }}>Sort incanté 4 niveau supérieur</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/6" }}>Incantation arcane</div>
