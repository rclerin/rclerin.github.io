export function PouvoirIndividuelPrint(data) {
    return (
        <div className="gridContainer">
            <div className="gridItem" style={{ gridColumn: "1/4" }}>Pouvoir</div>
            <div className="gridItem" style={{ gridColumn: "4/6" }}>Coût niv 1</div>

            <div className="gridItem gridItemLarge" style={{ gridColumn: "1/4" }}>{data.data.nom}</div>
            <div className="gridItem" style={{ gridColumn: "4/6" }}>{!data.data.cout_n1 ? "-" : data.data.cout_n1}</div>
