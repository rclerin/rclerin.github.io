export function PouvoirIndividuel(data) {
    return (
        <div className="gridContainer">
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/4" }}>Pouvoir</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "4/6" }}>Coût niv 1</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Description</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/4" }}>Type de bonus :</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Pré-requis 1</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/4" }}>Pré-requis 2</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "4/6" }}>Pré-requis 3</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Fréquence</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/4" }}>Activation</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "4/6" }}>Défense</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/3" }}>Annulé par</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/4" }}>Composante matérielle requise</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "4/5" }}>Catégorie de pouvoir</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "5/6" }}>Répétition</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/2" }}>Niveau 2</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "2/3" }}>Coût niv 2</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/5" }}>Niveau 3</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "5/6" }}>Coût niv 3</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/2" }}>Niveau 4</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "2/3" }}>Coût niv 4</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/5" }}>Niveau 5</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "5/6" }}>Coût niv 5</div>
            ...
            <div className="gridItem gridItemBold" style={{ gridColumn: "1/2" }}>Niveau 6</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "2/3" }}>Coût niv 6</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "3/5" }}>Niveau 7</div>
            <div className="gridItem gridItemBold" style={{ gridColumn: "5/6" }}>Coût niv 7</div>
