export function PouvoirIndividuel(data) {
    return (
        <div className="responsive-grid-container">
            ...
            <div className="row">
                <div className="col-6 col-xs-4 bold">Pré-requis 1</div>
                <div className="col-2 col-xs-4 bold">Pré-requis 2</div>
                <div className="col-4 col-xs-4 bold">Pré-requis 3</div>
            </div>
            <div className="row">
                <div className="col-6 col-xs-4">{!data.data.prerequis1 ? "-" : data.data.prerequis1}</div>
                <div className="col-2 col-xs-4">{!data.data.prerequis2 ? "-" : data.data.prerequis2}</div>
                <div className="col-4 col-xs-4">{!data.data.prerequis3 ? "-" : data.data.prerequis3}</div>
            </div>
            <div className="row">
                <div className="col-6 col-xs-4 bold">Fréquence</div>
                <div className="col-2 col-xs-4 bold">Activation</div>
                <div className="col-4 col-xs-4 bold">Défense</div>
            </div>
            <div className="row">
                <div className="col-6 col-xs-4">{data.data.frequence}</div>
                <div className="col-2 col-xs-4">{!data.data.activation ? "-" : data.data.activation}</div>
                <div className="col-4 col-xs-4">{!data.data.defense ? "-" : data.data.defense}</div>
            </div>
            <div className="row">
                <div className="col-8 col-xs-6 bold">Annulé par</div>
                <div className="col-4 col-xs-6 bold">Composante matérielle requise</div>
            </div>
            <div className="row">
                <div className="col-8 col-xs-6">{!data.data.annule_par ? "-" : data.data.annule_par}</div>
                <div className="col-4 col-xs-6">{!data.data.materiel_requis ? "-" : (data.data.materiel_requis ? "oui" : "non")}</div>
            </div>
            <div className="row">
            ...
            <div className="row">
                <div className="col-5 col-xs-4 bold">Niveau 2</div>
                <div className="col-1 col-xs-2 bold">Coût niv 2</div>
                <div className="col-5 col-xs-4 bold">Niveau 3</div>
                <div className="col-1 col-xs-2 bold">Coût niv 3</div>
            </div>
            <div className="row">
